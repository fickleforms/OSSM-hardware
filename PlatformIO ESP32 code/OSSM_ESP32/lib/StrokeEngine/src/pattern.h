...
class JackHammer : public Pattern {
    public:
        ...
        motionParameter nextTarget(unsigned int index) {
            Serial.println("nextTarget called with index: " + String(index) + " current _index: " + String(_index));
            ...
            if (index == 0 || _nextMove.stroke >= _depth) {
                ...
                Serial.println("in JackHammer revert step");
                // maximum speed of the trapezoidal motion
                _nextMove.speed = int(1.5 * _stroke/_timeOfStroke);
                // acceleration to meet the profile
                ...
                _nextMove.stroke = _depth - _stroke;
                Serial.println("_nextMove.speed: " + String(_nextMove.speed) + " _nextMove.acceleration: " +
                                String(_nextMove.acceleration) + " _nextMove.stroke: " + String(_nextMove.stroke));
                Serial.println("based on _stroke: " + String(_stroke) + " _timeOfStroke: " + String(_timeOfStroke) + "_depth: " + String(_depth));
            ...
            if (index != _index) {
                Serial.println("in JackHammer normal step");
